...
import thanaData from '../Personal Account Sections/thana.json';
import PostOfficeData from '../Personal Account Sections/postOffice.json'
                            ...
                            <div style={{ display: 'flex', width: '100%' }}>
                                ...
                                <div style={{ flex: '80%', paddingLeft: '10px' }}>
                                    <div className="value">
                                        ...
                                        >
                                            <option value="">Select</option>
                                            {(formData.CountryOfRes === 'BD' || (!isCountryOfResEdited && defaultValues.CountryOfRes === 'BD')) && (
                                                <>
